...
namespace Core
{
    ...
    {
        [Header("Match / Booster thresholds")]
        public int MinMatchForBlast = 2;
        public int MinMatchForBooster = 5;

        [Header("Busy durations (ticks)")]
        public int DefaultBusyDuration = 3;
        public int BombBusyDuration = 4;
        public int RocketBusyDuration = 3;

        [Header("Replay / Gravity")]
        public int GravityTicksBetweenActions = 1;

        [Header("Fall animation")]
        public float FallCellsPerSecond = 8f;
