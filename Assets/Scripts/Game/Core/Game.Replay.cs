...
namespace Core
{
    public partial class Game
    {
        ...
        private readonly List<PlayerAction> _recorded = new();
        ...
        public void RecordAction(PlayerAction action)
        {
            ...
            if (ActionQueue != null) ActionQueue.Enqueue(action);
        }

        public void StartReplay()
        {
            if (_recorded.Count == 0 || ActionQueue == null || Level == null) return;
        ...
        {
            if (!IsReplaying || ActionQueue == null) return;
            ...
            if (_tickCounter % ticksBetween != 0) return;
            ...
            PlayerAction action = _recorded[_replayIndex++];
            action.Time = 0f;
